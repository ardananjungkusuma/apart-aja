        ...
        <div class="col-md-12" style="margin-left:70px;margin-right:70px;">
            ...
            ?>
                ...
                <div class="card-body" style="font-size: 18px">
                    <div class="card-body">
                        <center>
                            <img style="width:286px;margin-bottom: 15px" src="<?= base_url() ?><?= $apartemen['gambar_apartemen'] ?>" alt="Card image cap">
                        </center>
                        <center>
                        ...
                        ?>
                            <div class="card" onclick="location.href='detail-ruang-apartemen.php?id_ruangan=<?= $ruanganApartemen['id_ruangan'] ?>'" style="width: 18rem;display:inline-block">
                                <img style="width:286px;height:180px" src="<?= base_url() ?><?= $ruanganApartemen['gambar_utama'] ?>" alt="Card image cap">
                                <div class="card-body">
