...
<div class="container" style="padding: 20px; margin: 10 px auto; margin-left: 220px; margin-right: auto;margin-top:50px;">
    <div class="row" style="margin-top: 80px;">
        <div class="col-lg-11" style="margin: 0 auto;">
            ...
            ?>
                <div class="card" style="width: 287px;display:inline-block;margin-left:5px;margin-right: 5px;margin-top: 15px;">
                    <a href="detail-apartemen-anda.php?id_ruangan=<?= $ruanganApartemen['id_ruangan'] ?>" style="text-decoration: none; color:black">
                    ...
                    <p class="card-text" style="font-size: 15px">&diams; <a href="detail-apartemen-anda.php?id_ruangan=<?= $ruanganApartemen['id_ruangan'] ?>" style="text-decoration: none;color:black"><?= $ruanganApartemen['nama_apartemen'] ?> Apartement</a> &diams;<br>Tipe <?= $ruanganApartemen['jenis_ruangan'] ?><br>Rp. <?= number_format($ruanganApartemen['harga_sewa'], 0, ',', '.');; ?>/Bulan</p>
