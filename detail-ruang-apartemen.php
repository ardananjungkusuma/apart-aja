                ...
                <div class="card-body" style="font-size: 18px">
                    ...
                    <div style="float: right;margin-right: 300px">
                        <form>
                            <div class="form-row">
                                <div class="col">
                                    <a href="#" class="btn btn-success" style="float: right;width:200px;">Buy This Room</a><br><br>
                                    <input type="number" placeholder="4" style="width: 50px;border: 2px solid #555;"> Bulan
                                    <a style="float:right;width:200px;margin-left:5px" href="#" class="btn btn-warning">Rent This Room</a>
                                </div>
                            </div>
                        </form>
                    </div>
