                ...
                <ul class="list-group">
                    ...
                    ?>
                        <li class="list-group-item">
                            <a href="detail-ruang-apartemen-anda.php?id_ruangan=<?= $ruanganApartemen['id_ruangan'] ?>"><?= $ruanganApartemen['nama'] ?></a>
                            <a href="detail-ruang-apartemen-anda.php?id_ruangan=<?= $ruanganApartemen['id_ruangan'] ?>" class="badge badge-danger float-right">Detail</a>
                        </li>
                    <?php
                    }
                    ?>
